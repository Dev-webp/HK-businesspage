  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/hkbgimg.jpg')", // Path to the image in the public folder
        }}
      ...
      >
        <div className="relative flex flex-col lg:flex-row items-center justify-between p-10 gap-10 min-h-screen">
          ...
          >
            ...
            >
              <span className="text-transparent bg-clip-text bg-gradient-to-tr from-white to-red-300 mt-6">
                Migrate to HongKong With Business Visa
              </span>
            </motion.h1>
            <motion.p
